...
class CarMake(models.Model):
    ...
    # Add any other fields you think are necessary for CarMake

    def __str__(self):
        return self.name  # Return the name as the string representation of a CarMake

# Car Model Model
class CarModel(models.Model):
    car_make = models.ForeignKey(CarMake, on_delete=models.CASCADE)  # Many-to-One relationship to CarMake
    dealer_id = models.IntegerField()  # Assuming dealer_id refers to the dealer created in the Cloudant database
    name = models.CharField(max_length=100)
    CAR_TYPES = [
        ('SEDAN', 'Sedan'),
        ('SUV', 'SUV'),
    ...
    # Add any other fields you think are necessary for CarModel
